...
#define STRING_CONFIG_H_AUTHOR "(Slugger, CTC i3 PRO B)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Slugger's mod :)"     // will be shown during bootup in line 2
...
#ifndef MOTHERBOARD
  //Slugger CTC i3 PRO B
  #define MOTHERBOARD BOARD_ULTIMAKER
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Slugger's 3D Printer"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
//
// Slugger CTC i3 PRO B mod
#define MACHINE_UUID "4f4ba42d-dc47-4daa-9dcc-a364f1c53d02"
...
#define LCD_FEEDBACK_FREQUENCY_HZ 1337
